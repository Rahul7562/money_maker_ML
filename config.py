...
WFO_MAX_PARAMETER_SETS = int(os.getenv("WFO_MAX_PARAMETER_SETS", "36"))
WFO_SIGNAL_STEP = int(os.getenv("WFO_SIGNAL_STEP", "5"))
WFO_TIME_BUDGET_SECONDS = float(os.getenv("WFO_TIME_BUDGET_SECONDS", "12"))
...
WFO_EMA_FAST_CANDIDATES = _as_int_list("WFO_EMA_FAST_CANDIDATES", "10,12,16,20,26")
WFO_EMA_SLOW_CANDIDATES = _as_int_list("WFO_EMA_SLOW_CANDIDATES", "34,40,50,70")
WFO_RSI_PERIOD_CANDIDATES = _as_int_list("WFO_RSI_PERIOD_CANDIDATES", "10,14,18")
WFO_MACD_FAST_CANDIDATES = _as_int_list("WFO_MACD_FAST_CANDIDATES", "8,12,16")
WFO_MACD_SLOW_CANDIDATES = _as_int_list("WFO_MACD_SLOW_CANDIDATES", "21,26,34")
WFO_MACD_SIGNAL_CANDIDATES = _as_int_list("WFO_MACD_SIGNAL_CANDIDATES", "7,9,12")
WFO_ATR_PERIOD_CANDIDATES = _as_int_list("WFO_ATR_PERIOD_CANDIDATES", "10,14,21")
WFO_MIN_SCORE_CANDIDATES = _as_float_list("WFO_MIN_SCORE_CANDIDATES", "0.54,0.58,0.62,0.66")
WFO_RSI_OVERSOLD_CANDIDATES = _as_float_list("WFO_RSI_OVERSOLD_CANDIDATES", "26,28,32,36")
WFO_RSI_OVERBOUGHT_CANDIDATES = _as_float_list("WFO_RSI_OVERBOUGHT_CANDIDATES", "64,68,72,76")
...
PAPER_GRADUATION_MIN_TRADES = int(os.getenv("PAPER_GRADUATION_MIN_TRADES", "40"))
PAPER_GRADUATION_MIN_WIN_RATE = float(os.getenv("PAPER_GRADUATION_MIN_WIN_RATE", "0.55"))
PAPER_GRADUATION_MIN_PROFIT_FACTOR = float(os.getenv("PAPER_GRADUATION_MIN_PROFIT_FACTOR", "1.20"))
PAPER_GRADUATION_MIN_TOTAL_PNL_USDT = float(os.getenv("PAPER_GRADUATION_MIN_TOTAL_PNL_USDT", "10.0"))
PAPER_GRADUATION_MAX_DRAWDOWN = float(os.getenv("PAPER_GRADUATION_MAX_DRAWDOWN", "8.0"))
WEEKLY_REPORT_WINDOW_DAYS = int(os.getenv("WEEKLY_REPORT_WINDOW_DAYS", "7"))
WEEKLY_REPORT_EVERY_HOURS = int(os.getenv("WEEKLY_REPORT_EVERY_HOURS", "6"))
